  ...
  return (
    <div className="relative">
      ...
      <Dropdown
        ...
        className="absolute md:left-auto md:-right-[240px] -left-[32px] mt-[17px] flex h-[480px] w-[350px] flex-col rounded-2xl border border-gray-200 bg-white p-3 shadow-theme-lg dark:border-gray-800 dark:bg-gray-dark sm:w-[361px] lg:right-0"
      >
        ...
        <ul className="flex flex-col h-auto overflow-y-auto custom-scrollbar">
          ...
          <div className="p-4 text-center text-gray-500 dark:text-gray-400">
            <div className="flex flex-col items-center justify-center py-6">
              ...
              <p className="text-xs text-gray-500 dark:text-gray-400">You’ll see updates and alerts here</p>
            </div>
          </div>
          {/* sample for notification list */}
          {/* <li>
            <DropdownItem
